                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-4 lg:grid-cols-2 bg-lime-500 w-full fixed top-0 left-0">
                        <div class="flex lg:justify-start lg:col-start-1 pl-6">
                            <a href="/">
                                <img src="{{ asset('logo.jpg') }}" alt="Logo" style="width: 190px; height: 40px;">
                            </a>
                        </div>
                        <!-- hamburger menu -->
                        ...
                        <nav class="hidden lg:flex flex-1 justify-end whitespace-nowrap font-bold pr-6">
                            ...
                            <a href=" {{ route ('schedule') }}" class="rounded-md px-3 py-2 text-blue-900 ring-1 ring-transparent transition hover:text-white focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">Schedule</a>
                        ...
                        <nav :class="{'block': open, 'hidden': !open}" class="hidden flex-col font-bold lg:hidden w-full bg-lime-500">
                            ...
                            <a href="{{ route ('schedule') }}" class="block rounded-md px-3 py-2 text-blue-900 ring-1 ring-transparent transition hover:text-white focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">Schedule</a>
                    ...
                    <footer class="my-20">
                        <p class="text-center text-sm text-slate-500">
                            Copyright © 2024 FirstCoach. All rights reserved.
                        </p>
